                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><?php echo isset($row['name']) ? ucwords($row['name']) : null ?></li>
                            </ol>
                    </nav>
                            ...
                            <a href="javascript:;" class="profileImageChange" title='click to change'>
                                ...
                                if($row['pic']){
                                   $img = $row['pic'];
                                    ...
                                    echo "<img class='img-thumbnail' src='admin/cars/profile/$img' width='100%' img='profilepic'>";
                                }else{
                                    echo "<img class='img-thumbnail' src='admin/cars/profile/profile-placeholder.png' width='100%'>";
                                }
                                ?>
